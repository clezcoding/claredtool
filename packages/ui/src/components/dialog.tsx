      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-2 right-2 inline-flex size-7 items-center justify-center rounded-md opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
...
function DialogFooter({
  ...
  return (
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close className="inline-flex items-center justify-center rounded-md border px-3 py-1.5 text-sm font-medium">
          Close
        </DialogPrimitive.Close>
      )}
    </div>
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn(
        "inline-flex items-center justify-center rounded-md border px-3 py-1.5 text-sm font-medium disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      {...props}
    />
