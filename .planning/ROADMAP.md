...
- [x] 04.4-01-PLAN.md — Rebase/ff origin/main; ci.yml draft + path-on-main; D-31 concurrency (D-33 commit 1)
...
- [x] 04.4-03-PLAN.md — Gitleaks SARIF, Actionlint in zizmor, CodeQL detect + language-split (D-33 commit 3)

**Wave 4** *(blocked on Wave 3; D-14 human gate)*

- [x] 04.4-04-PLAN.md — Signed desktop tags+dispatch only; GH Release; runner pins (D-33 commit 4)

**Wave 5** *(blocked on Wave 4)*

- [x] 04.4-05-PLAN.md — Dependabot caps, monthly Actions/Docker, Nest major group (D-33 commit 5)

**Wave 6** *(blocked on Wave 5; D-24 human gate)*

- [x] 04.4-06-PLAN.md — Drop GHCR latest; delete migrate job; collapse deploy (D-33 commit 6)
...
- [ ] 04.6-02-PLAN.md — D-18/D-22 helpers + D-23 fixtures 2–3 + paper layout locks

**Wave 3** *(blocked on Wave 2)*

- [ ] 04.6-03-PLAN.md — Nest InvoicePdfService sync; drop queue/Chromium/worker sources; Ready without Gotenberg (D-25)

**Wave 4** *(blocked on Wave 3)*

- [ ] 04.6-04-PLAN.md — Dockerfile pdf-templates+wasm; GHA + deploy script API-only (D-09)

**Wave 5** *(blocked on Wave 4; D-01/D-02 one-way gate)*

- [ ] 04.6-05-PLAN.md — compose/env drop; 04.3 ops addendum; Coolify/Kuma deletes (D-24)
...
- [x] 04.3-01-PLAN.md — Wave 0: image pins + Nyquist RED/GREEN stubs (PDF/OFFL/AUDT prep)

**Wave 2** *(blocked on Wave 1)*

- [x] 04.3-02-PLAN.md — Tracer: local Gotenberg + BullMQ worker HTML convert
- [x] 04.3-04-PLAN.md — Desktop SQLCipher + dialog/fs/sharekit debug smokes (parallel with 02)

**Wave 3** *(blocked on 02)*

- [x] 04.3-03-PLAN.md — Pino + OTel SDK local export off
- [x] 04.3-05-PLAN.md — Coolify internal Gotenberg + clared-worker (parallel with 03)

**Wave 4** *(blocked on 03+05; 06 also waits on 05)*

- [x] 04.3-06-PLAN.md — Copy H1/H2 from .env + Coolify Kuma/Beszel + Healthchecks cron

**Wave 5** *(blocked on 06; serializes clared-api env after 06)*

- [x] 04.3-07-PLAN.md — Grafana Loki Tempo Prometheus collector + OTEL env
