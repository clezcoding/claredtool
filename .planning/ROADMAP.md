...
- [ ] 04-01-PLAN.md — Crafted Minimal token split + OS-follow theme engine + Darstellung menu + splash (blocks all)

**Wave 2** *(blocked on Wave 1; 04-02 and 04-03 parallel)*

- [ ] 04-02-PLAN.md — Rechnung / Tax / PDF restyle (tabular money, Sage press, PdfPaper D-09 guard)
- [ ] 04-03-PLAN.md — Entities / Kunden / Auth restyle + shared states + Crafted asset swap + Login-Gate hero
...
| 4. Premium UI & Brand Redesign | 0/3 | Not started | - |
